...
const nqlPayload = (identifiers, action) => {
    ...
    return (0, exports.toTransportSeparator)([identifiers, actionString], separator);
};
exports.nqlPayload = nqlPayload;
const toTransportSeparator = (recordArray, separator) => {
    var _a, _b, _c;
    let byteLength = 0;
...
const toGroupSeparator = (records, data) => {
    const separatorArray = new Uint8Array(1);
    separatorArray[0] = enum_1.ESeparator.Group;
    const bitLength = records.byteLength + separatorArray.byteLength + data.byteLength;
...
//# sourceMappingURL=transport_old.js.map